function analyzeSurveyData() {
  ...
  // MODIFIED: Updated aspect ranges for Pedagogik, Profesional, Kepribadian, Sosial, Kedisiplinan, Penilaian Hasil Belajar
  const aspects = {
    'Pedagogik': { startCol: 'F', endCol: 'J' },
    'Profesional': { startCol: 'K', endCol: 'Q' },
    'Kepribadian': { startCol: 'R', endCol: 'U' },
    'Sosial': { startCol: 'V', endCol: 'Y' },
    'Kedisiplinan': { startCol: 'Z', endCol: 'AC' },
    'Penilaian Hasil Belajar': { startCol: 'AD', endCol: 'AF' }
  };
