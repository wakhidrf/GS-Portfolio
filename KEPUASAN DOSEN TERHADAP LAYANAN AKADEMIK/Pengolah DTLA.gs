function analyzeSurveyData() {
  ...
  // MODIFIED: Updated aspect ranges and removed 'Transparency'
  const aspects = {
    'Tangibles': { startCol: 'D', endCol: 'H' },
    'Reliability': { startCol: 'I', endCol: 'L' },
    'Responsiveness': { startCol: 'M', endCol: 'R' },
    'Assurance': { startCol: 'S', endCol: 'W' },
    'Empathy': { startCol: 'X', endCol: 'AB' }
  };
