function analyzeSurveyData() {
  ...
  const aspects = {
    'Tangibles': { startCol: 'F', endCol: 'T' },
    'Reliability': { startCol: 'U', endCol: 'AE' },
    'Responsiveness': { startCol: 'AF', endCol: 'AO' },
    'Assurance': { startCol: 'AP', endCol: 'AS' },
    'Empathy': { startCol: 'AT', endCol: 'AX' },
    'Transparency': { startCol: 'AY', endCol: 'BB' }
  };
